...
;; Test painter draws a right angle triangle in the frame
(define painter-test (segments->painter (list (make-segment 0.0 0.0 1.0 0.0)
...
;;((beside painter-test painter-test) frm)
;;((below-1 painter-test painter-test) frm)
((below-2 painter-test painter-test) frm)
