...
;;(define p0 (make-polynomial 'x '(0 0 0)))
;;(define p1 (make-polynomial 'x '(1 3 0 0)))
;;(define p2 (make-polynomial 'x '(3 0 1 2 0)))
;;(define p3 (make-polynomial 'x '(1 0 0 0 0 -1)))
;;(define p4 (make-polynomial 'x '(1 0 -1)))
